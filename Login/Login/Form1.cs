...
namespace Login
{
    ...
    public partial class Form1 : Form
    {
        public Form1()
        {
            ...
            this.ck_b_shpass.CheckedChanged += new System.EventHandler(this.ck_b_shpass_CheckedChanged);
        ...
        private void TrimiteEmailCuParola(string destinatar, string utilizator, string parola)
        {
            try
            {
                ...
                mail.From = new MailAddress("monitorizaresol0@gmail.com");
                ...
                smtp.Credentials = new NetworkCredential("monitorizaresol@gmail.com", "pfib vndg ohos ozqh"); // parola generata 
                smtp.EnableSsl = true;
                smtp.Send(mail);
        ...
        private void button_Conectare_Click(object? sender, EventArgs e)
        {
            try
            {
                ...
                serialPort.PortName = comboBox1.SelectedItem.ToString(); // Portul selectat, ex: COM5
        ...
        private void SerialPort_DataReceived(object sender, SerialDataReceivedEventArgs e)
        {
            try
            {
                ...
                // Ignora orice alt text care nu incepe corect
        ...
        private void button_refresh_Click(object? sender, EventArgs e)
        {
            try
            {
                // 1. Resetarea valorilor etichetelor la starea initiala
                label_temp.Text = " ";
                label_umiditate.Text = " ";
                label_niv_hidratare.Text = " ";
                label1.Text = "";  // Sterge plantele recomandate

                // 2. Verifica daca portul serial este deschis si trimite comanda pentru a obtine date noi
        ...
        private void button_salvare_Click(object? sender, EventArgs e)
        {
            try
            {
                // Folosim direct textul din label-uri (care contine unitati)
        ...
        private void button_verificare_Click(object? sender, EventArgs e)
        {
            try
            {
                // Extrage valorile masurate si elimina unitatile de masura
                ...
                using (SqlConnection con = new SqlConnection("Data Source=localhost\\SQLEXPRESS;Initial Catalog=MonitorizareSol;Integrated Security=True;TrustServerCertificate=True"))
                {
                    ...
                    using (SqlCommand cmd = new SqlCommand(query, con))
                    {
                        ...
                        using (SqlDataReader reader = cmd.ExecuteReader())
                        {
                            ...
                            string ora = now.ToString("HH:mm:ss"); // Formatul orei: ora:minut:secunda


                            // incarcarea fontul Arial din sistem 
